...
Установка:
```
https://github.com/maminparen/ft_irc_42.git
make
```
...
Запуск клиента:
- ```nc localhost [PORT] [PASS]```
- Графический клиент Pidgin (Linux)
- Графический клиент Adium (MacOS)

---
К серверу прилагается бот, который, переводит положительные числа в строчную запись словами. <br>
---
